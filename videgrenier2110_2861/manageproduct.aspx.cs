...
WebConfigurationManager.ConnectionStrings["videgrenierCS"].ConnectionString;
        ...
        protected void btnupdate_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "update tblProduct set prod_name = @pname, usage_time = @usage_time, prod_desc = @desc, cost_of_prod = @cost, brand_name = @brand, expiry_date = @exp, pictures = @pic, status = @status where prod_id=@pid";
        ...
        protected void gvs_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "SELECT * FROM tblProduct where prod_id = @pid";
            SqlDataReader dr;
            con.Open();
